...
sf::Text CreateTextButton(sf::Window& window, sf::Vector2f position, sf::Font& font, sf::String text = "Default", unsigned int charSize = 24, sf::Text::Style style = sf::Text::Regular);